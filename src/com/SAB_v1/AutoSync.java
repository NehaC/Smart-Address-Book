//Sync contacts, call list,tasks with server automatically after particular time
package com.SAB_v1;
...
public class AutoSync extends Activity 
{
	...
	return type:void
	date:29-6-11
	purpose:Sync contacts,tasks,etc to and from server*/
	protected void sync1() 
	{
		...
		else if(f.isChecked()==true)
		{
			...
			db1.Inserttask(town1, tname1, tdesp1,ttype1,tprio1,tcat1,tsdate1,tddate1,ttime1,con1,loc1);
			try
			{	ArrayList<NameValuePair> nv = new ArrayList<NameValuePair>();
